...
\begin{tikzpicture}[
    ...
    %%     \node[station, label={[stlabel]right:NODE\_ID}, below=2cm of A] (B) {};
    %%
    station/.style={
        draw,
    ...
    %% stlabel-end: use on start/end nodes for emphasis.
    %%   Usage:
    %%     \node[station, label={[stlabel-end]right:NAME}] (A) {};
    stlabel-end/.style={stlabel, font=\ttfamily\bfseries, color=yellow!50!black},
...
\node[station, label={[stlabel-end]right:UStr\_Upper\_MTR\_Exit}]
    (UStr_Upper_MTR_Exit) {};
...
\node[station, label={[stlabel]right:RunmeS\_4F}, below right=45pt and 30 pt of RunmeS_GF_Entrance]
    (RunmeS_4F) {};
\node[station, label={[stlabel-end]right:MengWahComplex\_1F}, below left=45pt and 30pt of RunmeS_4F]
    (MengWahComplex_1F) {};
