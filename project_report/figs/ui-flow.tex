...
\draw[arrv] (choice.west) -- (2.5, -4.2) -- (2.5, -6.5) node[lbl, midway, right] {Visualiser} -- (visapp.east);
...
\draw[arr] (solutions.east) -- (details.west)
    node[lbl, midway, above] {View Details};
...
\draw[arr]
    (mainapp.east) -- (8.5, -6.5) node[lbl, pos=0.4, below] {Quit} -- (8.5, -2.0) -- (selector.east);
